...
namespace Service.IntegrationTests
{
  ...
  public class MockClient3 : IClientCallback
  {
    ...
    public virtual void ConfirmGameSessionJoined(Guid gameToken, GameSessionManager.GameStates gameState)
    {
  ...
  public class MockClient : MockClient3, IClientCallback
  {
    ...
    public override void ConfirmGameSessionJoined(Guid gameToken, GameSessionManager.GameStates gameState)
    {
      this.GameToken = gameToken;
