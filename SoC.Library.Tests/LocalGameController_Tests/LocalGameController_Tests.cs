...
namespace Jabberwocky.SoC.Library.UnitTests.LocalGameController_Tests
{
    ...
    public class LocalGameController_Tests : LocalGameControllerTestBase
    {
        ...
        public void CompleteSetupWithPlayerInFirstSlot_ExpectedPlacementsAreReturned()
        {
            ...
            gameEvents[1].ShouldBe(new SetupInfrastructurePlacedEvent(secondOpponent.Id, SecondSettlementOneLocation, SecondRoadOneEnd));
            gameEvents[2].ShouldBe(new SetupInfrastructurePlacedEvent(thirdOpponent.Id, ThirdSettlementOneLocation, ThirdRoadOneEnd));
            gameEvents[3].ShouldBe(new SetupInfrastructurePlacedEvent(thirdOpponent.Id, ThirdSettlementTwoLocation, ThirdRoadTwoEnd));
            ...
            gameEvents[5].ShouldBe(new SetupInfrastructurePlacedEvent(secondOpponent.Id, SecondSettlementTwoLocation, SecondRoadTwoEnd));
            ...
            gameEvents[7].ShouldBe(new SetupInfrastructurePlacedEvent(firstOpponent.Id, FirstSettlementTwoLocation, FirstRoadTwoEnd));
        ...
        public void CompleteSetupWithPlayerInThirdSlot_ExpectedPlacementsAreReturned()
        {
            ...
            localGameController.ContinueGameSetup(MainSettlementOneLocation, MainRoadOneEnd);
            gameEvents.Count.ShouldBe(3);
            gameEvents[0].ShouldBe(new SetupInfrastructurePlacedEvent(thirdOpponent.Id, ThirdSettlementOneLocation, ThirdRoadOneEnd));
            gameEvents[1].ShouldBe(new SetupInfrastructurePlacedEvent(thirdOpponent.Id, ThirdSettlementTwoLocation, ThirdRoadTwoEnd));
            ...
            //gameEvents[0].ShouldBe(new ResourcesCollectedEvent(testInstances.MainPlayer.Id, new[] { new ResourceCollection(MainSettlementTwoLocation, new ResourceClutch(1, 1, 0, 0, 1)) }));
            gameEvents[1].ShouldBe(new SetupInfrastructurePlacedEvent(secondOpponent.Id, SecondSettlementTwoLocation, SecondRoadTwoEnd));
           // gameEvents[2].ShouldBe(new ResourcesCollectedEvent(secondOpponent.Id, new[] { new ResourceCollection(SecondSettlementTwoLocation, new ResourceClutch(0, 0, 1, 1, 1)) }));
            gameEvents[3].ShouldBe(new SetupInfrastructurePlacedEvent(firstOpponent.Id, FirstSettlementTwoLocation, FirstRoadTwoEnd));
        ...
        public void CompleteSetupWithPlayerInFourthSlot_ExpectedPlacementsAreReturned()
        {
            ...
            gameEvents[1].ShouldBe(new SetupInfrastructurePlacedEvent(thirdOpponent.Id, ThirdSettlementTwoLocation, ThirdRoadTwoEnd));
            //gameEvents[2].ShouldBe(new ResourcesCollectedEvent(thirdOpponent.Id, new[] { new ResourceCollection(ThirdSettlementTwoLocation, new ResourceClutch(0, 1, 1, 0, 1)) }));
            gameEvents[3].ShouldBe(new SetupInfrastructurePlacedEvent(secondOpponent.Id, SecondSettlementTwoLocation, SecondRoadTwoEnd));
            ...
            gameEvents[5].ShouldBe(new SetupInfrastructurePlacedEvent(firstOpponent.Id, FirstSettlementTwoLocation, FirstRoadTwoEnd));
