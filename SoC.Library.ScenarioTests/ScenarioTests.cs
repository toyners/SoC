...
namespace SoC.Library.ScenarioTests
{
    ...
    public class ScenarioTests
    {
            ...
            this.CreateStandardLocalGameControllerScenarioRunner()
                ...
                .PlayerTurn_Old(MainPlayerName, 4, 4)
                    .Events()
                        ...
                        .End()
                    .EndTurn()
                .PlayerTurn_Old(FirstOpponentName, 1, 2)
                    .Events()
                        .DiceRollEvent(1, 2)
                        .End()
                    .EndTurn()
                .PlayerTurn_Old(SecondOpponentName, 3, 4)
                    .Events()
                        .DiceRollEvent(3, 4)
                        .End()
                    .EndTurn()
                .PlayerTurn_Old(ThirdOpponentName, 5, 6)
                    .Events()
                        .DiceRollEvent(5, 6)
                        .End()
                    .EndTurn()
        ...
        {
            this.CreateStandardLocalGameControllerScenarioRunner()
                .PlayerTurn_Old(MainPlayerName, 1, 5)
                    .Events()
        ...
        [Test]
        public void Scenario_ComputerPlayerBuildsCity_Old()
        {
            this.CreateStandardLocalGameControllerScenarioRunner()
                .WithNoResourceCollection()
                .WithStartingResourcesForPlayer(ThirdOpponentName, ResourceClutch.City)
                .PlayerTurn_Old(MainPlayerName, 5, 6).EndTurn()
                .PlayerTurn_Old(FirstOpponentName, 5, 6).EndTurn()
                .PlayerTurn_Old(SecondOpponentName, 3, 3).EndTurn()
                .PlayerTurn_Old(ThirdOpponentName, 3, 3)
                    .Actions()
                        .BuildCity(33)
                        .End()
                    .Events()
        ...
        public void Scenario_ComputerPlayerHasEightVictoryPointsAndBuildsLargestArmyToWin()
        {
            ...
            this.CreateStandardLocalGameControllerScenarioRunner()
                ...
                .PlayerTurn_Old(MainPlayerName, 3, 3).EndTurn()
                .PlayerTurn_Old(FirstOpponentName, 3, 3)
                    .Actions()
                        .PlayKnightCard(4)
                        .End()
