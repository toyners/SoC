            ...
            try
            {
                this.CompletePlayerInfrastructureSetup()
                    ...
                    .WhenPlayer(Adam)
                        ...
                        .ReceivesGameErrorEvent(ErrorCodes.LocationsNotDirectlyConnected, "Locations (4, 0) not connected when placing road segment").ThenDoNothing()
                    .VerifyPlayer(Babara)
                        .DidNotReceiveEventOfType<GameErrorEvent>()
                    .VerifyPlayer(Charlie)
                        .DidNotReceiveEventOfType<GameErrorEvent>()
            ...
            try
            {
                this.CompletePlayerInfrastructureSetup()
                    ...
                    .WhenPlayer(Adam)
                        .ReceivesStartTurnEvent(3, 3)
                        .ThenPlaceRoadSegment(4, 3)
                        .ReceivesGameErrorEvent(ErrorCodes.NotEnoughRoadSegments, "No road segments to place").ThenDoNothing()
                    .VerifyPlayer(Babara)
                        .DidNotReceiveEventOfType<GameErrorEvent>()
                    .VerifyPlayer(Charlie)
                        .DidNotReceiveEventOfType<GameErrorEvent>()
            ...
            try
            {
                this.CompletePlayerInfrastructureSetup()
                    ...
                    .WhenPlayer(Adam)
                        ...
                        .ReceivesGameErrorEvent(ErrorCodes.LocationAlreadyOccupiedByPlayer, "Cannot place road segment on existing road segment (4, 12)").ThenDoNothing()
                    .VerifyPlayer(Babara)
                        .DidNotReceiveEventOfType<GameErrorEvent>()
                    .VerifyPlayer(Charlie)
                        .DidNotReceiveEventOfType<GameErrorEvent>()
        ...
        public void PlayerPlaysRoadBuildingCardButDoesNotHaveEnoughRoadSegments(int remainingRoadSegments)
        {
            try
            {
                this.CompletePlayerInfrastructureSetup()
                    ...
                    .WhenPlayer(Adam)
                        .ReceivesStartTurnEvent(3, 3).ThenPlayRoadBuildingCard(4, 3, 3, 2)
                        .ReceivesGameErrorEvent(ErrorCodes.NotEnoughRoadSegments, "No Road building card owned that can be played this turn")
                    .VerifyPlayer(Babara)
                        .DidNotReceiveEventOfType<RoadBuildingCardPlayedEvent>()
                        .DidNotReceiveEventOfType<GameErrorEvent>()
                    .VerifyPlayer(Charlie)
