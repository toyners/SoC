        ...
        public void Scenario_AllPlayersCollectResourcesAsPartOfTurnStart(string[] args)
        {
            ...
            this.CompletePlayerInfrastructureSetup(args)
                .WhenPlayer(Adam)
                    ...
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneBrick).EndPlayerStateMeasuring()
                    .ThenEndTurn()
                .WhenPlayer(Babara)
                    .ReceivesResourceCollectedEvent(firstTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneGrain).EndPlayerStateMeasuring()
                .WhenPlayer(Charlie)
                    .ReceivesResourceCollectedEvent(firstTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.Zero).EndPlayerStateMeasuring()
                .WhenPlayer(Dana)
                    .ReceivesResourceCollectedEvent(firstTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.Zero).EndPlayerStateMeasuring()
                ...
                .WhenPlayer(Babara)
                    ...
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneGrain + ResourceClutch.OneOre).EndPlayerStateMeasuring()
                    .ThenEndTurn()
                .WhenPlayer(Adam)
                    .ReceivesResourceCollectedEvent(secondTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneBrick).EndPlayerStateMeasuring()
                .WhenPlayer(Charlie)
                    .ReceivesResourceCollectedEvent(secondTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneLumber * 2).EndPlayerStateMeasuring()
                .WhenPlayer(Dana)
                    .ReceivesResourceCollectedEvent(secondTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneOre).EndPlayerStateMeasuring()
                
                .WhenPlayer(Charlie)
                    .ReceivesDiceRollEvent(1, 2).ThenDoNothing()
                    .ReceivesResourceCollectedEvent(thirdTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources((ResourceClutch.OneLumber * 2) + ResourceClutch.OneOre).EndPlayerStateMeasuring()
                    .ThenEndTurn()
                .WhenPlayer(Adam)
                    .ReceivesResourceCollectedEvent(thirdTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneBrick).EndPlayerStateMeasuring()
                ...
                .WhenPlayer(Adam)
                    .ReceivesResourceCollectedEvent(fourTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneBrick + ResourceClutch.OneWool).EndPlayerStateMeasuring()
                .WhenPlayer(Babara)
                    .ReceivesResourceCollectedEvent(fourTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources(ResourceClutch.OneGrain + ResourceClutch.OneOre + ResourceClutch.OneWool).EndPlayerStateMeasuring()
                .WhenPlayer(Charlie)
                    .ReceivesResourceCollectedEvent(fourTurnCollectedResources)
                    .ThenMeasurePlayerState().WithResources((ResourceClutch.OneLumber * 2) + ResourceClutch.OneOre).EndPlayerStateMeasuring()
