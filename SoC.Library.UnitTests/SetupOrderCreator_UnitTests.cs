...
namespace Jabberwocky.SoC.Library.UnitTests
{
  ...
  public class SetupOrderCreator_UnitTests
  {
    ...
    {
      var player1 = new PlayerDataBase();
      var player2 = new PlayerDataBase();
      var player3 = new PlayerDataBase();
      var player4 = new PlayerDataBase();

      var players = new PlayerDataBase[] { player1, player2, player3, player4 };
      ...
      setupOrder.ShouldBe(new PlayerDataBase[] { players[first], players[second], players[third], players[fourth]});
    }
    ...
    {
      var players = new PlayerDataBase[] { new PlayerDataBase(), new PlayerDataBase(), new PlayerDataBase() };
      var mockDice = NSubstitute.Substitute.For<IDice>(); 
      mockDice.RollTwoDice().Returns(firstRoll, secondRoll, thirdRoll, fourthRoll);
      var setupOrder = SetupOrderCreator.Create(players, mockDice);

      setupOrder.ShouldBe(new PlayerDataBase[] { players[first], players[second], players[third] });
    }
    #endregion 
  }
}
